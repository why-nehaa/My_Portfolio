...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Neha Kumari";
	const description =
		"Hello! I'm Neha Kumari, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
		"/assets/avatar.png";
	const url = "https://why-nehaa.vercel.app/";
